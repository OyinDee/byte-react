...
const AboutByte = () => {
  return (
    <>
      ...
      <section className="min-h-screen bg-olive-dark text-accentwhite px-6 py-20 pb-36 pt-36 font-sans">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-4xl sm:text-5xl font-bold mb-6 text-cheese">
            About <span className="text-primary-800">Byte</span><span>!</span>
          </h1>
          ...
          <div className="mt-12 text-center">
            ...
            <a
              href="/"
              className="inline-block bg-primary-800 hover:bg-primary-700 text-white px-6 py-3 rounded-xl shadow-soft transition"
            >
              🍔 Back to Home 🍔
            </a>
          </div>
